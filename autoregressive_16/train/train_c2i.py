    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        for x, y in loader:
            ...
            with torch.cuda.amp.autocast(dtype=ptdtype):  
                _, loss = model(cond_idx=c_indices, idx=z_indices, targets=z_indices)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--vocab-size", type=int, default=8192, help="vocabulary size of visual tokenizer")
