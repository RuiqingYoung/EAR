...
from autoregressive_31.models.gpt_opt import GPT_models
from autoregressive_31.models.generate import generate
...
def main(args):
    ...
    seed = 42 # args.global_seed * dist.get_world_size() + rank
...
###################################################################################        
        ...
        code_b = index_sample.view(index_sample.shape[0], 16, 16).long()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--sample-dir", type=str, default="samples31")
